<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-10-24 16:35:31
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '848461492580a41ba3b5714-74988920',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_580a41ba3bf5d2_20002344',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580a41ba3bf5d2_20002344')) {function content_580a41ba3bf5d2_20002344($_smarty_tpl) {?><!DOCTYPE html><!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="es-CO"> <![endif]-->
<!--[if IE 7]>         <html class="no-js lt-ie9 lt-ie8" lang="es-CO"> <![endif]-->
<!--[if IE 8]>         <html class="no-js lt-ie9" lang="es-CO"> <![endif]-->
<!--[if gt IE 8]><!--> <html class="no-js" lang="es-CO"> <!--<![endif]--><head><meta charset="utf-8"><title>index</title><meta name="description" content="Meta description Ready"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1"><link rel="stylesheet" href="css/libs/bootstrap.min.css"><link rel="stylesheet" href="css/libs/animate.min.css"><link rel="stylesheet" href="css/main.min.css"><!-- Web Fonts--><link href="https://fonts.googleapis.com/css?family=Varela+Round|Roboto:400italic,300,700,400" rel="stylesheet" type="text/css"><!--[if lt IE]>
<?php echo '<script'; ?>
...
</h3><form><label for="E-mail">E-mail</label><input class="datos-login" type="text" id="user"><div class="clear"></div><label for="Contraseña">Contraseña</label><input class="datos-login" type="password" id="password"><input type="button" id="btn-login" value="Aceptar"><div class="clear"></div><em class="diferen-registro">ó</em><div class="clear"></div><label class="face-connect" for="ConectarconFacebook">Conectar con fACEBOOK
</label><button class="conect-facebook"><img class="img-responsive" src="images/Img-LogoFb.png" alt="Jugar"></button></form><em class="inform-princi"> Ingresa para continuar acumulando bon bon bum y llegar al primer puesto en la tabla de posiciones.
</em></div><div class="division-form-L"></div><div class="cont-regis-confirmacion" id="btn-no-register"><h3 class="titulo-registrados no-regis">No
...
><?php echo '<script'; ?>
 type="text/javascript" src="js/index.min.js"><?php echo '</script'; ?>
></body></html><?php }} ?>
