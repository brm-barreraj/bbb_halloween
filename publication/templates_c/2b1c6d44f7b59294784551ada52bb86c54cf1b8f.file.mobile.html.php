<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-11-04 21:50:43
...
><!--script(type="text/javascript",src="js/libs/hammer.min.js")--><!--script(type="text/javascript",src="js/libs/shake.min.js")--><!--script(type="text/javascript",src="js/actionsmobile.min.js?<?php echo $_smarty_tpl->tpl_vars['random']->value;?>
")--><!--script(type="text/javascript",src="js/clientmobile.min.js?<?php echo $_smarty_tpl->tpl_vars['random']->value;?>
")--><!--script(type="text/javascript",src="js/eventsmobile.min.js?<?php echo $_smarty_tpl->tpl_vars['random']->value;?>
")--></body></html><?php }} ?>
