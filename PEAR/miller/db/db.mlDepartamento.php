<?php
/**
 * Table Definition for ml_departamento
 */

class DataObject_MlDepartamento extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'ml_departamento';                 // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObject_MlDepartamento',$k,$v); }
